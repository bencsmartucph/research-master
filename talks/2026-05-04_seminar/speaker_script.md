# Speaker Script — Dignity Is a Baseline
...
> Good afternoon. The paper is called "Dignity Is a Baseline."
>
> The thirty-second version: workers exposed to automation are more anti-immigration than their material interests would predict, the gap is bigger in some welfare states than in others, and the conventional explanation — that more generous welfare buffers the political backlash — is wrong about the mechanism in a specific and testable way. The mechanism is asymmetric. I'll show you why.

**Don't read the slide. Look up. Engage the room early.**

---

## SLIDE 2 — The puzzle (90 seconds)

> Workers in routine-task-intensive occupations — what we call RTI workers — across Europe disproportionately support populist radical right parties. This is a robust finding. Gingrich, Kurer, Im and colleagues, Autor and colleagues, Gallego and Kurer all document it.
>
> The pattern has cross-national variation. The same automation exposure converts into anti-immigration sentiment more readily in some welfare states than in others.
>
> The dominant explanation in the literature treats welfare generosity as a buffer. Spend more, get less populism.
>
> I want to argue today that this account is missing the mechanism it claims to describe. Not wrong that welfare matters — wrong about *how* welfare matters. The consequences for how we think about welfare-state design are real.

**Pause briefly after "missing the mechanism." Let the claim land.**
...
**Reading the quotes is fine here — they're the centrepiece of the slide. Slow down.**
...
>
> That last sentence is the paper's title in compressed form. It's also the move that distinguishes this paper from the buffering literature it's responding to.

**Pause AT LEAST two beats after "without producing it." This is the paper's central claim. Let it land.**
...
## SLIDE 11 — ALMP vs CWED (120 seconds) ⭐ EMPIRICAL HEADLINE

> This is the paper's most important empirical contrast.
>
> Same fifteen Western European countries. Two ways of measuring welfare. Each dot in the plot is a country. The y-axis is how strongly RTI predicts anti-immigration sentiment in that country — bigger value, steeper slope.
>
> [Point to ALMP result.] ALMP spending — what most of the buffering literature uses as its measure of welfare effort — has a correlation of plus point zero one with the slope. Essentially zero. Spending more on labour market policies has nothing to do with the cross-national pattern.
>
> [Point to CWED result.] CWED decommodification — the degree to which the welfare state lets you sustain yourself without market employment — has a correlation of *negative point eight five*. Seventy-two percent of the cross-national variation. UK lowest, Norway highest. The pattern is exactly what the asymmetric mechanism predicts and exactly what the buffering account cannot explain.
>
> What's the difference between the measures? ALMP captures *effort*. You can spend a lot on punitive workfare. CWED captures *decommodification* — what the welfare state lets you have, not what it costs to provide. The dignity dimension travels along the second variable.

**This is your strongest empirical moment. Slow. Land each beat. The "negative point eight five" should hit.**
...
>
> [Point to table.] Individual-level interaction with country-wave fixed effects: unemployment generosity, beta minus zero point zero five three, p less than point zero zero one. Sickness intermediate. Pensions weakest, marginally significant only.
>
> Predicted ordering UE greater than SK greater than PEN. Observed ordering at individual level: same. The damage cascade fires through the point of economic vulnerability, not through welfare expenditure in the abstract.
>
> For thesis design, this matters. The within-Denmark test should focus on unemployment benefit reforms — the 2003, 2006, 2013 activation reforms. Pension reforms should not show damage signatures of the same magnitude. We have a within-country falsification test for the asymmetric mechanism.

**This is the new contribution. Confident, brief. The fact you ran it this week shows you're testing the theory actively, not defending a finished position.**

---

## SLIDE 13 — Asymmetric confirmation (60 seconds)
...
>
> Welfare context cleanly attenuates the conversion of vulnerability into exclusion. It does not detectably moderate the conversion of the same vulnerability into solidarity.
>
> Two ways to read the null. As a measurement limitation. Or as a substantive confirmation — the mechanism *is* asymmetric. The supplementary ISSP analysis on different data with a different outcome returns the same null. I take the substantive reading. It's what the theory predicts.

**The "substantive reading" line is your commitment. Don't soften it.**

---

## SLIDE 14 — Implications (60 seconds)

> Four implications.
>
> *For welfare-state theory*: the political consequences of welfare design travel along *what* welfare communicates, not *how much* it spends. Decommodification is a measure of the former. Spending is a measure of the latter.
>
...
>
> *For the thesis follow-up*: Danish registry data on individuals before and after the 2003, 2006, and 2013 activation reforms — testing within-individual whether conditionality shocks produce damage signatures.

**Four bullets at speaking pace = ~60 seconds. Don't elaborate beyond what's on the slide.**
...
**Don't pad. Five short lines. Trust the pause. End on "questions" — invite, don't trail off.**
...
> Yes. The country-level finding survives all single-country exclusions. Excluding the UK gives r=−0.80; excluding Norway gives r=−0.79; excluding both jointly gives r=−0.72 with p=0.006. The individual-level Model 3 interaction (β=−0.06, p=0.015, N=82,000) is the more defensible test and gives the same direction.

### "How do you handle Denmark — high CWED but steep slope?"

> Backup slide. Danish flexicurity combines generous transfers with demanding activation requirements. The asymmetric mechanism predicts conditionality damages even when transfer levels are high — Denmark is confirmation, not anomaly. The 2003/2006/2013 activation reforms are exactly the kind of within-country shock the theory predicts should produce damage signatures.

### "What about Burgoon and Schakel 2022? They find welfare generosity DOES dampen anti-globalisation."

> Backup slide. They measure platform language at the party level; I measure attitudinal slopes at the individual level. Both can be true: welfare generosity may dampen the *supply* of anti-globalisation rhetoric in party systems while the *demand* for exclusionary attitudes among vulnerable workers responds to a different welfare dimension. My contribution is identifying that dimension as decommodification.

### "How do you operationalise 'dignity'?"

> Indirectly. Decommodification is the proxy. The CWED score captures whether welfare lets a worker sustain themselves without dependence on market employment — which is institutional dignity in measurable form. The richer measurement (whether the encounter leaves a person feeling like a citizen or a supplicant) requires within-individual data the cross-section can't supply. That's the registry follow-up.

### "Why call it 'dignity' and not 'recognition' or 'social esteem'?"

> Three reasons. First, dignity is the term the recognition literature itself increasingly uses (Kurer & Palier, Gidron & Hall). Second, dignity has a baseline structure that recognition doesn't — you can be denied dignity in a way you can't be denied "recognition" symmetrically. Third, the asymmetry I'm claiming maps better onto dignity: damage to dignity is observable; presence of dignity is, by design, less visible because it's the absence of stigmatisation.

### "What about cultural-backlash explanations? Norris-Inglehart?"

> Cultural backlash is consistent with my findings, not a rival to them. What I add is the institutional condition under which backlash is more or less likely to fire. The cultural reading of economic disruption isn't autonomous of welfare context — it's one of the cascade outcomes welfare context shapes.

### "Your sample is 15 Western European countries. Generalisable?"

> Honestly: external validity to non-European contexts is not tested. The mechanism should travel — welfare-as-allocation-and-judgement is general — but the empirical pattern documented here is European. The US, with its very different welfare architecture, is where I'd want to test next.
...
- Which slide did the audience seem most engaged with?
- What question caught you off-guard? (This is the most valuable signal.)
- Where did you feel rushed? Slow that section for the next iteration.
- The peer reviewer's feedback — file it but don't over-weight it (they're a peer, not Amalie).
